 ...
 * @goals
 * This class aims to be implemented by the container of the ListView using PersonArrayAdapter
 */
public interface PersonArrayAdapterCallBack {
	/**
	 * Ask the parent to load more data
	 */
