...
import com.android2ee.project.gplus.signin.publicid.ui.MainActivity;
 ...
 */
public class MomentCallBackActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (deepLink.isHierarchical() && deepLink.getPath().startsWith("/user/")) {
			...
			Log.e("MomentCallBackActivity", "Not starting with user");
		}
